...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your ONEonONE private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new ONEonONE network down to  |")
	...
	log.Info("Administering ONEonONE network", "name", w.network)
